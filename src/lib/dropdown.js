...
function Dropdown(props) {
    ...
    return (
        <div ref={ref}>
            <Button type="text" name="button" onClick={switchIsOpen} data-testid="selected-value">
...

            {
                isOpen &&
                (
                    <Select data-testid="select" onClick={handleClick} width={ref.current && ref.current.offsetWidth}>
                        {options.map((option) => (
